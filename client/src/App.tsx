...
function Router() {
  return <Switch><Route path="/" component={Home} /><Route path="/s/:shareId" component={SharedHomebrew} /><Route path="/404" component={NotFound} /><Route component={NotFound} /></Switch>;
}
